...
public class CancelledError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class DeadlineExceededError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class PermissionDeniedError(string message) : Error(message);

/// <summary>
/// Some resource has been exhausted, perhaps a per-user quota, or perhaps the entire file system is out of space.
/// </summary>
/// <param name="message"></param>
public class ResourceExhaustedError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class FailedPreconditionError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class AbortedError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class OutOfRangeError(string message) : Error(message);

/// <summary>
/// The operation is not implemented or is not supported/enabled in this service.
/// </summary>
/// <param name="message"></param>
public class UnimplementedError(string message) : Error(message);
...
/// </summary>
/// <param name="message"></param>
public class UnavailableError(string message) : Error(message);

/// <summary>
/// Unrecoverable data loss or corruption.
/// </summary>
/// <param name="message"></param>
public class DataLossError(string message) : Error(message);

/// <summary>
/// The request does not have valid authentication credentials for the operation.
/// </summary>
/// <param name="message"></param>
public class UnauthenticatedError(string message) : Error(message);